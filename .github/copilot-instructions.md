...
- **Project**: bmad-command
- **User**: V
- **Communication Language**: Indonesia
- **Document Output Language**: Indonesia
- **User Skill Level**: intermediate
- **Output Folder**: {project-root}/vdocs
- **Planning Artifacts**: {project-root}/vdocs/planning-artifacts
- **Implementation Artifacts**: {project-root}/vdocs/implementation-artifacts
